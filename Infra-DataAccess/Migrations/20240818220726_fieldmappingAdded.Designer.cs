...
namespace Infra_DataAccess.Migrations
{
    ...
    [Migration("20240818220726_fieldmappingAdded")]
    partial class fieldmappingAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Contact", b =>
                {
                    ...
                    b.OwnsMany("Domain.FieldMapping", "FieldMappings", b1 =>
                        {
                            b1.Property<Guid>("ContactNMFLoId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ContactNMFLoId", "Id");

                            b1.ToTable("FieldMapping");

                            b1.WithOwner()
                                .HasForeignKey("ContactNMFLoId");
                        });
